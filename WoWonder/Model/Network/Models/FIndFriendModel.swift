...
import Foundation
class FIndFriendModel:BaseModel{
    struct FIndFriendSuccessModel: Codable {
        let apiStatus: Int?
    ...
    struct NearbyUser: Codable {
        ...
        let age, distance, userGeoinfo: String?
        var isFollowing: Int?
    ...
    enum IsFollowing: String, Codable {
        case no = "no"
    }
    ...
    struct FIndFriendErrorModel: Codable {
