...
// MARK: - REPLY
indirect enum MessageReply: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        if let x = try? container.decode(MessageModel.self) {
            self = .message(x)
            return
        }
        throw DecodingError.typeMismatch(MessageReply.self, DecodingError.Context(codingPath: decoder.codingPath,
                                                                           debugDescription: "Wrong type for ReplyUnion"))
    }
